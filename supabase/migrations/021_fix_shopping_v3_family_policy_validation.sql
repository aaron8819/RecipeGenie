-- Fix the V3 ingredient policy-key check without changing the accepted V2/V3
-- contract, the V2 column default, or any stored Shopping document.
begin;

create or replace function public.is_shopping_document_v3(p_document jsonb)
returns boolean
language plpgsql
immutable
security definer
